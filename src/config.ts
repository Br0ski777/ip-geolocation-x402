  ...
  routes: [
    {
      ...
      toolDescription: "Use this when you need to geolocate an IP address. Returns: country, region, city, latitude, longitude, timezone, ISP, organization, ASN, connection type, VPN/proxy/tor detection flag. Supports IPv4 and IPv6. Do NOT use for domain lookups — use domain_lookup_intelligence instead.",
      inputSchema: {
        type: "object",
        properties: {
